            ...
            <div className='relative overflow-hidden'>
              ...
              <div>
                <p>
                  ...
                  family Iguanidae, characterized by its long tail, strong
                  limbs, and sharp claws.
                </p>
                <p className='mt-8'>
                  Historically, it has been a popular pet due to its docile
                  nature, but its introduction into non-native habitats has led
                  to significant ecological and economic challenges.
                </p>
              </div>
              <div>
                <p>
